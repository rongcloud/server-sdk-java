...
public class Group {
    ...
    public Group(String appKey, String appSecret, Proxy proxy) {
        this.appKey = appKey;
        this.appSecret = appSecret;
        this.proxy = proxy;
    }
    ...
    public CodeSuccessReslut create(String[] userId, String groupId, String groupName) throws Exception {
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret, "/group/create.json", "application/x-www-form-urlencoded",proxy);
    ...
    public CodeSuccessReslut sync(String userId, GroupInfo[] groupInfo) throws Exception {
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret, "/group/sync.json", "application/x-www-form-urlencoded",proxy);
        HttpUtil.setBodyParameter(body, conn);
    ...
    public CodeSuccessReslut refresh(String groupId, String groupName) throws Exception {
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret, "/group/refresh.json", "application/x-www-form-urlencoded",proxy);
        HttpUtil.setBodyParameter(body, conn);
    ...
    public CodeSuccessReslut join(String[] userId, String groupId, String groupName) throws Exception {
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret, "/group/join.json", "application/x-www-form-urlencoded",proxy);
        HttpUtil.setBodyParameter(body, conn);
    ...
    public GroupUserQueryReslut queryUser(String groupId) throws Exception {
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret, "/group/user/query.json", "application/x-www-form-urlencoded",proxy);
        HttpUtil.setBodyParameter(body, conn);
    ...
    public CodeSuccessReslut quit(String[] userId, String groupId) throws Exception {
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret, "/group/quit.json", "application/x-www-form-urlencoded",proxy);
        HttpUtil.setBodyParameter(body, conn);
    ...
    public CodeSuccessReslut addGagUser(String userId, String groupId, String minute) throws Exception {
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret, "/group/user/gag/add.json", "application/x-www-form-urlencoded",proxy);
        HttpUtil.setBodyParameter(body, conn);
    ...
    public ListGagGroupUserReslut lisGagUser(String groupId) throws Exception {
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret, "/group/user/gag/list.json", "application/x-www-form-urlencoded",proxy);
        HttpUtil.setBodyParameter(body, conn);
    ...
    public CodeSuccessReslut rollBackGagUser(String[] userId, String groupId) throws Exception {
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret, "/group/user/gag/rollback.json", "application/x-www-form-urlencoded",proxy);
        HttpUtil.setBodyParameter(body, conn);
    ...
    public CodeSuccessReslut dismiss(String userId, String groupId) throws Exception {
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(HostType.API, appKey, appSecret, "/group/dismiss.json", "application/x-www-form-urlencoded",proxy);
        HttpUtil.setBodyParameter(body, conn);
