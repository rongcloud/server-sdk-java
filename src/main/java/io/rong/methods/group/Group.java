...
public class Group {
    ...
    public Result create(GroupModel group) throws Exception {
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getConfig(), appKey, appSecret, "/group/create.json",
          "application/x-www-form-urlencoded");
        HttpUtil.setBodyParameter(body, conn, rongCloud.getConfig());
        return (GroupMemberCount) GsonUtil.fromJson(
          CommonUtil.getResponseByCode(PATH, CheckMethod.CREATE, HttpUtil.returnResult(conn, rongCloud.getConfig())), GroupMemberCount.class);
    }
    ...
    public Result sync(UserGroup user) throws Exception {
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getConfig(), appKey, appSecret, "/group/sync.json",
          "application/x-www-form-urlencoded");
        HttpUtil.setBodyParameter(body, conn, rongCloud.getConfig());

        return (ResponseResult) GsonUtil.fromJson(
          CommonUtil.getResponseByCode(PATH, CheckMethod.SYNC, HttpUtil.returnResult(conn, rongCloud.getConfig())), ResponseResult.class);
    }
    ...
    public Result update(GroupModel group) throws Exception {
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getConfig(), appKey, appSecret, "/group/refresh.json",
          "application/x-www-form-urlencoded");
        HttpUtil.setBodyParameter(body, conn, rongCloud.getConfig());
        return (ResponseResult) GsonUtil.fromJson(
          CommonUtil.getResponseByCode(PATH, CheckMethod.UPDATE, HttpUtil.returnResult(conn, rongCloud.getConfig())), ResponseResult.class);
    }
    ...
    public Result invite(GroupModel group) throws Exception {
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getConfig(), appKey, appSecret, "/group/join.json",
          "application/x-www-form-urlencoded");
        HttpUtil.setBodyParameter(body, conn, rongCloud.getConfig());

        return (ResponseResult) GsonUtil.fromJson(
          CommonUtil.getResponseByCode(PATH, CheckMethod.INVITE, HttpUtil.returnResult(conn, rongCloud.getConfig())), ResponseResult.class);
    }
    ...
    public Result join(GroupModel group) throws Exception {
        ...
        return (GroupMemberCount) GsonUtil.fromJson(
          CommonUtil.getResponseByCode(PATH, CheckMethod.JOIN, HttpUtil.returnResult(conn, rongCloud.getConfig())), GroupMemberCount.class);
    }
    ...
    public GroupUserQueryResult get(GroupModel group) throws Exception {
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getConfig(), appKey, appSecret, "/group/user/query.json",
          "application/x-www-form-urlencoded");
        HttpUtil.setBodyParameter(body, conn, rongCloud.getConfig());

        return (GroupUserQueryResult) GsonUtil.fromJson(
          CommonUtil.getResponseByCode(PATH, CheckMethod.GET, HttpUtil.returnResult(conn, rongCloud.getConfig())), GroupUserQueryResult.class);
    }
    ...
    public Result quit(GroupModel group) throws Exception {
        ...
        sb.append("&isDelAttention=").append(URLEncoder.encode(group.getIsDelAttention().toString(), UTF8));
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getConfig(), appKey, appSecret, "/group/quit.json",
          "application/x-www-form-urlencoded");
        HttpUtil.setBodyParameter(body, conn, rongCloud.getConfig());

        return (ResponseResult) GsonUtil.fromJson(
          CommonUtil.getResponseByCode(PATH, CheckMethod.QUIT, HttpUtil.returnResult(conn, rongCloud.getConfig())), ResponseResult.class);
    }
    ...
    public Result dismiss(GroupModel group) throws Exception {
        ...
        HttpURLConnection conn = HttpUtil.CreatePostHttpConnection(rongCloud.getConfig(), appKey, appSecret, "/group/dismiss.json",
          "application/x-www-form-urlencoded");
        HttpUtil.setBodyParameter(body, conn, rongCloud.getConfig());

        return (ResponseResult) GsonUtil.fromJson(
          CommonUtil.getResponseByCode(PATH, CheckMethod.DISMISS, HttpUtil.returnResult(conn, rongCloud.getConfig())), ResponseResult.class);
    }
    ...
    private StringBuilder operateGroup(StringBuilder sb, GroupModel group) {
        if (group.isBindNotifyMsg()) {
            ...
            if (StringUtils.isNotBlank(group.getFromUserId())) {
                sb.append("&fromUserId=").append(group.getFromUserId());
            }
            if (StringUtils.isNotBlank(group.getObjectName())) {
                sb.append("&objectName=").append(group.getObjectName());
            }
            if (StringUtils.isNotBlank(group.getContent())) {
            ...
            if (StringUtils.isNotBlank(group.getPushData())) {
            ...
            if (StringUtils.isNotBlank(group.getPushExt())) {
