...
public class Push {
     ...
     **/
    public BroadcastResult broadcast(BroadcastModel broadcast) throws Exception {
        // 需要校验的字段
        String message = CommonUtil.checkFiled(broadcast, PATH, CheckMethod.BROADCAST);
        if (null != message) {
            return (BroadcastResult) GsonUtil.fromJson(message, BroadcastResult.class);
        }
        ...
        return (BroadcastResult) GsonUtil.fromJson(
