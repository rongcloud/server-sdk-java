...
public class PlatformNotificationTest {
    ...
    public void testBuild() {
        ...
        platformNotification.setOhos(platform);
        Assert.assertEquals("{\"thread-id\":\"thread-id\",\"interruption-level\":\"passive\",\"ohos\":{\"large_icon_uri\":\"large_icon_uri\",\"collapse_key\":\"collapse_key\",\"category\":\"test\"}}", GsonUtil.toJson(platformNotification));
    }
}