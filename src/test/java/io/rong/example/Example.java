...
public class Example {
    ...
    public void setUp() throws Exception {
        String appKey = "kj7swf8ok3142";
        String appSecret = "CkSeWjqvhy";
        rongCloud = RongCloud.getInstance(appKey, appSecret);
        // rongCloud = RongCloud.getInstance(appKey, appSecret,api);
        /**
         * 自定义备用 API 地址用法 List apiList = new ArrayList<>();
         * apiList.add("http://api2-cn.ronghub.com");
         * apiList.add("http://api-na02.ronghub.com"); rongCloud =
         * RongCloud.getInstance(appKey, appSecret,api,apiList);
         */
    }
    ...
    public void testRegister() throws Exception {
        ...
        UserModel user = new UserModel().setId("userId1").setName("username")
    ...
    public void testAddBlacklist() throws Exception {
        ...
        UserModel user = new UserModel().setId("hdsjGB89").setBlacklist(blacklist);
    ...
    public void testSendBroadcast() throws Exception {
        BroadcastMessage message = new BroadcastMessage().setSenderId("OScHVP1tQ").setObjectName(txtMessage.getType())
                .setContent(txtMessage).setPushContent("this is a push").setPushData("{'pushData':'hello'}")
                .setOs("Android");
    ...
    public void testSendPrivate() throws Exception {
        Reader reader = null;
        PrivateMessage privateMessage = new PrivateMessage().setSenderId("userId").setTargetId(targetIds)
                .setObjectName(voiceMessage.getType()).setContent(voiceMessage).setPushContent("")
                .setPushData("{\"pushData\":\"hello\"}").setCount("4").setVerifyBlacklist(0).setIsPersisted(0)
                .setIsCounted(0).setIsIncludeSender(0);
    ...
    public void testRecallPrivate() throws Exception {
        RecallMessage message = new RecallMessage().setSenderId("OScHVP1tQ").setTargetId("NomSvNyME")
                .setuId("B8FV-QAHO-I1E4-JLRI").setSentTime("1548334967010");
    ...
    public void testSendGroup() throws Exception {
        // 群组消息
        GroupMessage groupMessage = new GroupMessage().setSenderId("Hji8yh76").setTargetId(targetIds)
                .setObjectName(txtMessage.getType()).setContent(txtMessage).setPushContent("this is a push")
                .setPushData("{\"pushData\":\"hello\"}").setIsPersisted(0).setIsCounted(0).setIsIncludeSender(0)
    ...
    public void testSendGroupMention() throws Exception {
        ...
        MentionMessage mentionMessage = new MentionMessage().setSenderId("userId").setTargetId(targetId)
                .setObjectName(txtMessage.getType()).setContent(content).setPushContent("this is a push")
                .setPushData("{\"pushData\":\"hello\"}").setIsPersisted(0).setIsCounted(0).setIsIncludeSender(0)
                .setContentAvailable(0);
    ...
    public void testRecallGroup() throws Exception {
        RecallMessage message = new RecallMessage().setSenderId("NomSvNyME").setTargetId("BauMbEShY")
                .setuId("B8FV-UKT9-TJMD-KV6A").setSentTime("1548335533735");
    ...
    public void testSendChatroom() throws Exception {
        // 聊天室消息
        ChatroomMessage message = new ChatroomMessage().setSenderId("targetIds").setTargetId(targetIds)
                .setContent(txtMessage).setObjectName(txtMessage.getType());
    ...
    public void testAddSensitiveword() throws Exception {
        SensitiveWordModel sentiveWord = new SensitiveWordModel().setType(0).setKeyword("黄赌毒").setReplace("***");
    ...
    public void testGroupUpdate() throws Exception {
        ...
        GroupModel group = new GroupModel().setId("hiuyr743k").setMembers(members).setName("RongCloud");
    ...
    public void testGroupJoin() throws Exception {
        GroupMember[] members = { new GroupMember().setId("ghJiu7H1"), new GroupMember().setId("ghJiu7H2") };
        GroupModel group = new GroupModel().setId("hgir769ll").setMembers(members).setName("RongClooud");
    ...
    public void testGroupAddGagUser() throws Exception {
        ...
        GroupMember[] members = { new GroupMember().setId("ghJiu7H1"), new GroupMember().setId("ghJiu7H2") };
        GroupModel group = new GroupModel().setId("appSecret").setMembers(members).setMinute(5);
    ...
    public void testGroupRollBackGagUser() throws Exception {
        GroupMember[] members = { new GroupMember().setId("ghJiu7H1"), new GroupMember().setId("ghJiu7H2") };
        GroupModel group = new GroupModel().setMembers(members).setId("jhgui85hh");
    ...
    public void testGroupBanUserResult() throws Exception {
        ...
        GroupModel groupModel = new GroupModel().setMembers(members).setMinute(1000000);
    ...
    public void testGroupBanUserRemoveResult() throws Exception {
        ...
        GroupModel groupModel = new GroupModel().setMembers(members);
    ...
    public void testGroupBanWhitelistRemoveResult() throws Exception {
        ...
        GroupModel groupModel = new GroupModel().setMembers(members).setId("groupId");
    ...
    public void addChatroomUserWhiteList() throws Exception {
        ChatroomMember[] members = { new ChatroomMember().setId("qawr34h"), new ChatroomMember().setId("qawr35h") };
        ChatroomModel chatroom = new ChatroomModel().setId("d7ec7a8b8d8546c98b0973417209a548").setMembers(members);
    ...
    public void testGetChatroomWhiteListMsg() throws Exception {
        ChatroomModel chatroom = new ChatroomModel().setId("d7ec7a8b8d8546c98b0973417209a548");
    ...
    public void testChatroomBan() throws Exception {
        ChatroomMember[] members = { new ChatroomMember().setId("qawr34h"), new ChatroomMember().setId("qawr35h") };
        ChatroomModel chatroom = new ChatroomModel().setMembers(members).setMinute(5);
    ...
    /**
     * API 文档:
     * http://www.rongcloud.cn/docs/server_sdk_api/chatroom/distribute.html#resume
     *
    ...
    public void testAddChatroomGag() throws Exception {
        ChatroomMember[] members = { new ChatroomMember().setId("qawr34h"), new ChatroomMember().setId("qawr35h") };
        ChatroomModel chatroom = new ChatroomModel().setId("hjhf07kk").setMembers(members).setMinute(5);
    ...
    public void testGetChatroomGag() throws Exception {
        ChatroomModel chatroom = new ChatroomModel().setId("hjhf07kk");
    ...
    public void testRemoveChatroomGag() throws Exception {
        ChatroomMember[] members = { new ChatroomMember().setId("qawr34h"), new ChatroomMember().setId("qawr35h") };
        ChatroomModel chatroom = new ChatroomModel().setId("hjhf07kk").setMembers(members);
    ...
    /**
     * API 文档:
     * http://www.rongcloud.cn/docs/server_sdk_api/chatroom/keepalive.html#add
     *
     * 添加保活聊天室
     *
     **/
    ...
    /**
     * API 文档:
     * http://www.rongcloud.cn/docs/server_sdk_api/chatroom/keepalive.html#remove
     *
     * 删除保活聊天室
     *
     **/
     ...
     *
     * API 文档:
     * http://www.rongcloud.cn/docs/server_sdk_api/chatroom/keepalive.html#getList
     *
     * 获取保活聊天室
     *
     **/
    ...
    **/
    ...
    public void testBroadcast() throws Exception {
        ...
        BroadcastResult result = rongCloud.push.broadcast(broadcast);
    ...
    **/
    ...
    public void testBatchSetTag() throws Exception {
        ...
        tag.setTags(new String[] {"男", "90后"});
        tag.setUserIds(new String[] {"userId1", "userId1"});
        Result result = rongCloud.user.tag.batchSet(tag);

        System.out.println("batchSet" + result.toString());
        assertEquals("200", result.getCode().toString());
    }
